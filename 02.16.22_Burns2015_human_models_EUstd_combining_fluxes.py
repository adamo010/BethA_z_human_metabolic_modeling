...
filelist = glob.glob('*V01_Burns2015_human_EUstd_fluxes.csv')

sample_names_list = []
for file in filelist:
    sample_name = re.sub("_V01_Burns2015_human_EUstd_fluxes.csv", "", file) #delete extra crap on string.
    sep="_"
...
all_fluxpath_df.to_csv("02.16.22_Burns2015_human_models_EUstd_fluxes_combined.csv")

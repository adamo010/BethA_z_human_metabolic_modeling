...
#how many unique fluxes are we including here? 
fluxpaths_zerofree_unique <- unique(analyzed_fluxpaths_wide_noNANs_zerofree$fluxpath_name) #167 fluxpaths
#clean up
...
write.csv(as.data.frame(fluxpath_statistics), file="02.15.22_CORDA_flux_exchanges_stats_Burns2015_data_highfiber.csv")
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_name %in% c("glc_D")), cond1= "normal", cond2= "tumor",
  ...
  labs(title = expression("D-glucose exchange flux, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.00201, q= 0.0362")) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_name %in% c("udpglcur")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("UDP glucuronic acid exchange flux, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.00191, q= 0.0362")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_name %in% c("nicrnt")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Nicotinic acid mononucleotide exchange flux, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.00640, q= 0.0768")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
  scale_y_continuous(name = "Average flux,\nmmol/(gDW * h)", limits=c(-600,1200)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  theme(legend.position = "bottom", legend.title=element_blank(), legend.text=element_text(size=11)) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_name %in% c("atp")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("ATP exchange flux, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0271, q= 0.172")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
  scale_y_continuous(name = "Average flux,\nmmol/(gDW * h)", limits=c(-600,1200)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_name %in% c("dxtrn")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Dextrin exchange flux, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0334, q= 0.172")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
  scale_y_continuous(name = "Average flux,\nmmol/(gDW * h)", limits=c(-100,600)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  theme(legend.position = "bottom", legend.title=element_blank(), legend.text=element_text(size=11)) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_name %in% c("pglyc_hs")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Phosphatidylglycerol exchange flux, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0241, q= 0.172")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_name %in% c("uri")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Uridine exchange flux, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0296, q= 0.172")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +

...
analyzed_fluxes <- read_csv("02.14.22_Burns2015_human_models_highfiber_fluxes_combined.csv") 
...
#how many unique fluxes are we including here? 
fluxpaths_zerofree_unique <- unique(analyzed_fluxpaths_wide_noNANs_zerofree$fluxpath_subsystem) #76 fluxpaths
#clean up
...
write.csv(as.data.frame(fluxpath_statistics), file="02.14.22_CORDA_flux_subsystems_stats_Burns2015_data_highfiber.csv")
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Pyrimidine catabolism")), cond1= "normal", cond2= "tumor",
  ...
  labs(title = expression("Pyrimidine catabolism flux, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.00449, q= 0.171")) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Exchange/demand reaction")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Exchange/demand reaction fluxes, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0232, q= 0.236")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
  scale_y_continuous(name = "Average flux,\nmmol/(gDW * h)", limits=c(0,50)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  theme(legend.position = "bottom", legend.title=element_blank(), legend.text=element_text(size=11)) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Galactose metabolism")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Galactose metabolism fluxes, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0435, q= 0.236")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
  scale_y_continuous(name = "Average flux,\nmmol/(gDW * h)", limits=c(-100,300)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  theme(legend.position = "bottom", legend.title=element_blank(), legend.text=element_text(size=11)) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Glutamate metabolism")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Glutamate metabolism fluxes, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0396, q= 0.236")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
  scale_y_continuous(name = "Average flux,\nmmol/(gDW * h)", limits=c(-200,400)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  theme(legend.position = "bottom", legend.title=element_blank(), legend.text=element_text(size=11)) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Lysine metabolism")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Lysine metabolism fluxes, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0362, q= 0.236")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Transport, endoplasmic reticular")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("ER transport fluxes, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0394, q= 0.236")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
  scale_y_continuous(name = "Average flux,\nmmol/(gDW * h)", limits=c(-20,40)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  theme(legend.position = "bottom", legend.title=element_blank(), legend.text=element_text(size=11)) +
...
ggpaired(subset(analyzed_fluxpaths_paired_wide, fluxpath_subsystem %in% c("Valine, leucine, and isoleucine metabolism")), cond1= "normal", cond2= "tumor",
         fill = "condition", line.color = "Difference_direction") +
  labs(title = expression("Val/Leu/Ile transport fluxes, Burns2015 data (human)"), subtitle = expression("paired Wilcoxan, p=0.0429, q= 0.236")) +
  theme(plot.title = element_text(hjust=0.5), plot.subtitle= element_text(hjust=0.5)) +
  scale_y_continuous(name = "Average flux,\nmmol/(gDW * h)", limits=c(-50,150)) +
  scale_x_discrete(labels = c('Normal','Tumor')) +
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  theme(legend.position = "bottom", legend.title=element_blank(), legend.text=element_text(size=11)) +

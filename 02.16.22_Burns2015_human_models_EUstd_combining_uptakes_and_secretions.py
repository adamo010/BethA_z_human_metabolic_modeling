...
filelist = glob.glob('*V01_Burns2015_human_EUstd_secretion.csv')

sample_names_list = []
for file in filelist:
    sample_name = re.sub("_V01_Burns2015_human_EUstd_secretion.csv", "", file) #delete extra crap on string.  
...
all_secretion_df.to_csv("02.16.22_Burns2015_human_models_EUstd_secretions_combined.csv")
    
##################and again for uptake!
filelist = glob.glob('*V01_Burns2015_human_EUstd_uptake.csv')

sample_names_list = []
for file in filelist:
    sample_name = re.sub("_V01_Burns2015_human_EUstd_uptake.csv", "", file) #delete extra crap on string.  
    sample_names_list.append(sample_name)
del file, sample_name
...
all_uptake_df.to_csv("02.16.22_Burns2015_human_models_EUstd_uptakes_combined.csv")
